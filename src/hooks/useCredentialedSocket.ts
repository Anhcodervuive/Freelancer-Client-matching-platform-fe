...
type EMap = Record<string, (..._args: any[]) => void>

export type CredentialedSocketResult<
	ServerToClientEvents extends EMap = EMap,
	ClientToServerEvents extends EMap = EMap
> = {
...
export const useCredentialedSocket = <
	ServerToClientEvents extends EMap = EMap,
	ClientToServerEvents extends EMap = EMap
>(
	namespace: string,
	options: CredentialedSocketOptions = {}
): CredentialedSocketResult => {
