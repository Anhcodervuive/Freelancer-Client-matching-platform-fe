...
import AdminContractListPage from './pages/Admin/contracts/List'
import AdminReviewListPage from './pages/Admin/reviews/List'
		...
		children: [
			...
			},
			{
				...
				element: <SubmitJobProposalPage />
                        ...
                        {
                                path: routes.client.financial.spending,
                                loader: composeLoaders(checkAuthenticatedUser, isClientUser),
                                element: <ClientSpendingStatisticsPage />
                        },
			{
