...
export default function JobChatLayout() {
        ...
        return (
                <div className='flex min-h-dvh flex-col bg-slate-100'>
                        ...
                        >
                                <div className='relative mx-auto flex h-full w-full max-w-[1240px] flex-1 flex-col overflow-hidden rounded-[32px] border border-white/70 bg-white/70 p-4 shadow-[0_30px_120px_rgba(15,23,42,0.12)] backdrop-blur'>
