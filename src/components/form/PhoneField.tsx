	...
	const [phone, setPhone] = useState(value ?? '')
        ...
        return (
				...
				// tinh chỉnh class để giống DaisyUI input
                                inputClassName='input input-bordered w-full !h-12 rounded-xl border-white/60 bg-white/70 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20'
