                        ...
                        <div className='flex-1 space-y-6 overflow-y-auto pr-1'>
                                ...
                                <div className='mt-4 grid grid-cols-2 gap-4 text-sm text-slate-600'>
                                        ...
                                        <div>
                                                ...
                                                <p className='font-medium text-slate-900'>{formatDate(thread.updatedAt)}</p>
                                        ...
                                        <div className='grid grid-cols-2 gap-3'>
                                                {images.map(image => (
                                                        <a
                                                                ...
                                                                download
                                                        >
                                                                <img src={image.previewUrl || image.url} alt={image.name} className='h-28 w-full object-cover transition duration-300 group-hover:scale-105' />
