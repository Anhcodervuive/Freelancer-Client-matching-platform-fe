...
import { CHAT_NAMESPACE, ChatClientEvent, type CHAT_PRESENCE_REPSONSE, type CHAT_PRESENCE_SYNC_REPSPONSE } from '~/constants/chat'
...
type ThreadPresenceMap = Record<string, Record<string, boolean>>
type ThreadParticipantsMap = Record<string, CHAT_PRESENCE_SYNC_REPSPONSE['thread']['participants']>
