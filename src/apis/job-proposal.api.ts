...
export const listFreelancerJobProposals = async (
	filters: JobProposalFilterInput = { page: 1, limit: 10 } // Fix: Added default values for page and limit
...
export const updateJobProposal = async (proposalId: string, payload: UpdateJobProposalInput): Promise<JobProposal> => {
