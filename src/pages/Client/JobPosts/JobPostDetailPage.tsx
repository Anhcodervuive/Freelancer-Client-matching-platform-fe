...
export default function JobPostDetailPage() {
        ...
        const durationLabel = job.duration ? durationMap[job.duration as JobDurationCommitment] ?? 'Duration flexible' : 'Duration flexible'
        ...
        return (
                <div className='mx-auto w-full max-w-5xl px-4 py-8 lg:px-0'>
                        <button
                                ...
                                onClick={() => navigate(routes.me.client.jobs.list)}
                        >
                                                        ...
                                                        {preferredLocations.length > 0 ? (
                                                                <div className='mt-2 flex flex-wrap gap-2'>
                                                                        {preferredLocations.map(location => (
                                                                                <span key={location.code} className='badge badge-soft badge-sm rounded-full bg-primary/10 text-primary'>
                                                                                        {location.label}
                                                                                </span>
                                                                        ))}
                                                                </div>
                                                ...
                                                {languages.length === 0 ? (
                                                        ...
                                                        <ul className='mt-3 space-y-3 text-sm text-base-content/80'>
                                                                {languages.map(language => {
                                                                        ...
                                                                        return (
                                                                                <li key={`${language.languageCode}-${language.proficiency}`} className='flex items-center justify-between rounded-xl bg-base-200/60 px-3 py-2'>
                                                ...
                                                {attachments.length === 0 ? (
                                                        ...
                                                        <ul className='mt-3 space-y-3 text-sm text-base-content/80'>
                                                                {attachments.map(attachment => (
                                                                        <li key={attachment.id ?? attachment.name} className='flex items-center justify-between rounded-xl bg-base-200/60 px-3 py-2'>
