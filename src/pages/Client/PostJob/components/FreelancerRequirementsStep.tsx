...
export function FreelancerRequirementsStep({ hidden }: FreelancerRequirementsStepProps) {
        ...
        const categories = useMemo(() => (categoryResponse as ListResponse<Category> | undefined)?.data ?? [], [categoryResponse])
        ...
        const specialties = useMemo(() => (specialtyResponse as ListResponse<Specialty> | undefined)?.data ?? [], [specialtyResponse])
                        ...
                        <div className='space-y-8'>
                                <div className='grid gap-6 lg:grid-cols-2'>
                                        <div>
                                                ...
                                                {errors.categoryId ? (
                                                        <p className='mt-2 text-xs text-error'>{errors.categoryId.message}</p>
                                                ) : null}
                                        </div>
                                        <div>
                                                <div className='mb-3 flex items-center justify-between gap-2'>
                                                ...
                                                {errors.specialtyId ? (
                                                        <p className='mt-2 text-xs text-error'>{errors.specialtyId.message}</p>
                                                ) : null}
                                        </div>
                                </div>
