...
export default function JobInvitationsPage() {
        ...
        const {
                ...
                isError,
                error
        } = useQuery<PaginatedJobInvitationResponse>({
        ...
        const canRespond = detail && !detailExpired && (!detailStatus || detailStatus === 'SENT' || detailStatus === 'PENDING')
                        ...
                        <div className='space-y-6 rounded-3xl border border-base-200 bg-base-100 p-6 shadow-sm'>
                                ...
                                <div className='space-y-4 text-sm text-base-content/70'>
                                        ...
                                        <div className='rounded-2xl border border-base-200 bg-base-200/40 p-4'>
                                                ...
                                                <Link
                                                        to={routes.freelancer.jobs.detail(detail.jobId)}
                                ...
                                <div className='flex flex-col gap-3 border-t border-base-200 pt-4 sm:flex-row'>
                                        <button
                                                ...
                                                onClick={() =>
                                                        ...
                                                        respondMutation.mutate({ id: selectedInvitationId, status: 'ACCEPTED' })
                                                }
                                        >
                                        ...
                                        <button
                                                ...
                                                onClick={() =>
                                                        selectedInvitationId &&
                                                        respondMutation.mutate({ id: selectedInvitationId, status: 'DECLINED' })
                                                }
                                        >
                                                {respondMutation.isPending ? (
                                                        <Loader2 className='size-4 animate-spin' />
